...
var LNG_JA = JSON.parse(fs.readFileSync(path.join(__dirname, '..', "language", "ja", "menu-tutorial.json"), "utf-8"));
var LNG_JAK = JSON.parse(fs.readFileSync(path.join(__dirname, '..', "language", "ja-k", "menu-tutorial.json"), "utf-8"));
